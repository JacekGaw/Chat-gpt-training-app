...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-2 w-full max-w-screen-md m-auto">
      <div id="chatOutput" className="w-full  bg-black bg-opacity-50 drop-shadow-lg rounded-xl h-[500px] *:text-slate-100 p-5">
        <p >Chat with bot will appear here...</p>
      </div>
      <form onSubmit={handleSubmit} className="w-full gap-2 flex justify-center ">
        <input type="text" placeholder="Type your message here..." className="flex-1 drop-shadow-lg bg-black bg-opacity-50 rounded-lg p-2 text-slate-100 font-[300]"/>
